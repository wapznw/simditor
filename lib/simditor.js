    ...
    this.editor.uploader.on('uploadsuccess', (function(_this) {
      return function(e, file, result) {
        ...
        if (result.isSuccess === false) {
          ...
          if (_this.editor.opts.upload && _this.editor.opts.upload.imgPrefix) {
            img_path = _this.editor.opts.upload.imgPrefix + img_path;
          }
        }
        _this.loadImage($img, img_path, function() {
          ...
          $img.removeData('mask');
          if (_this.editor.opts.upload && _this.editor.opts.upload.imgPrefix) {
            $img.attr('data-src', img_path.substr(_this.editor.opts.upload.imgPrefix.length));
          }
        ...
        if (_this.popover.active) {
          ...
          return _this.popover.srcEl.val(result.body.fileUrl);
        }
      };
    })(this));
